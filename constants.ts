...
const RAW_DATA = `
  ...
  第10组（单词901-1000）action, actually, adjective, afraid, agreed, ahead, allow, apple, arrived, born, bought, British, capital, chance, chart, church, column, company, conditions, corn, cotton, cows, create, dead, deal, death, details, determine, difficult, division, doesn't, effect, entire, especially, evening, experience, factories, fair, fear, fig, forward, France, fresh, Greek, gun, hoe, huge, isn't, led, level, located, march, match, molecules, northern, nose, office, opposite, oxygen, plural, prepared, pretty, printed, radio, repeated, rope, rose, score, seat, settled, shoes, shop, similar, sir, sister, smell, solution, southern, steel, stretched, substances, suffix, sugar, tools, total, track, triangle, truck, underline, various, view, Washington, we'll, western, win, women, workers, wouldn't, wrong, yellow, 
  第11组（NGSL补充1）really, issue, market, service, offer, program, thank, spend, support, public, price, parent, local, concern, rate, sort, share, development, future, involve, social, political, sale, policy, further, require, individual, research, computer, situation, staff, activity, film, account, event, decision, available, community, role, health, true, phone, date, model, customer, economic, approach, charge, claim, relationship, nice, improve, regard, organization, couple, range, quality, project, opportunity, accord, therefore, kid, education, likely, certainly, national, teach, security, benefit, risk, standard, vote, percent, focus, stage, realize, data, address, performance, accept, society, technology, mention, choice, culture, demand, limit, due, effort, attention, reduce, personal, patient, evidence, exist, leader, former, contact, particularly, sport, discuss, response, apply, court, police, knowledge, source, employee, manage, simply, firm, article, attack, foreign, feature, recently, 
  第12组（NGSL补充2）affect, recent, relate, official, financial, campaign, private, pause, forget, worry, drink, opinion, manager, international, nature, structure, myself, press, whatever, growth, influence, respect, skill, attempt, medium, average, stock, management, character, establish, indeed, final, economy, guy, function, yesterday, image, behavior, station, population, fail, environment, production, contract, player, comment, occur, significant, drug, series, success, tomorrow, director, clearly, lack, review, depend, recognize, purpose, department, gain, college, argue, holiday, achieve, item, prove, season, stuff, anyone, analysis, election, military, hotel, club, movie, discussion, sorry, challenge, nearly, link, despite, introduce, advantage, marry, strike, seek, ability, hospital, interview, agreement, release, tax, popular, specific, aim, television, serious, target, degree, husband, access, treat, identify, loss, pressure, bus, treatment, worth, attend, investment, organize, beyond, promise, potential, relation, 
  第13组（NGSL补充3）file, bar, suffer, strategy, advance, network, generally, operation, avoid, throw, task, normal, goal, associate, positive, option, message, instance, style, refer, quarter, assume, successful, doubt, competition, theory, propose, reference, argument, adult, document, application, obviously, unclear, search, central, career, anyway, speech, officer, throughout, oil, profit, protect, resource, disease, balance, damage, basis, author, basic, encourage, male, operate, reflect, useful, restaurant, income, previous, imagine, okay, earn, daughter, post, newspaper, define, conclusion, clock, everybody, weekend, perform, professional, debate, memory, maintain, credit, afternoon, prefer, extend, possibility, facility, variety, daily, screen, completely, female, responsibility, original, dream, nor, university, easily, agency, fix, yeah, legal, proposal, version, conversation, somebody, magazine, immediately, welcome, communication, agent, traditional, replace, judge, herself, generation, estimate, favorite, difficulty, purchase, shoot, 
`;

export const FRY_WORD_GROUPS: WordGroup[] = (() => {
